...
Label(root, text="Digite o nome do projeto:", bg='#ADD8E6').grid(row=0, column=0, sticky='w', padx=10, pady=5)
project_name_entry = Entry(root)
project_name_entry.grid(row=1, column=0, sticky='ew', padx=10, pady=5)
